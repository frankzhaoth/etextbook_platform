...
export default function(PDFJS) {
	...
	function PDFJSWrapper(canvasElt, annotationLayerElt, emitEvent) {
		...
		this.createTextLayer = function(rotate, canvas) {
			
			if ( rotate === undefined )
				rotate = 0;

			var scale = $(canvas).outerWidth() / pdfPage.getViewport(1).width;
			console.log(scale, pdfPage.getViewport(1).width);
			var viewport = pdfPage.getViewport(scale, rotate);
			...
			$('#text-layer div').css({position: 'absolute'});
		},
